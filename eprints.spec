...
%{!?_epversion: %define _epversion 3.4.7}
...
Source0: https://github.com/eprints/eprints3.4/archive/v%{_epversion}.tar.gz
BuildArch: noarch
...
Requires: perl(JSON) perl(Text::Unidecode) perl(IO::String)
Requires: tetex-latex wget gzip tar ImageMagick unzip python3-html2text
...
%changelog
* Sat Feb 18 2023 David R Newman <drn@ecs.soton.ac.uk>
 - Replaced elinks with python3-html2text

* Sat Jul 11 2020 David R Newman <drn@ecs.soton.ac.uk>
 - Added perl-JSON and perl-Text-Unidecode dependencies
